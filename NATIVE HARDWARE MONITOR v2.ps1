...
# Aumentado para 1540 para comportar as Colunas maiores
$form.ClientSize = New-Object System.Drawing.Size(1540, 900) 
...
# Aumentado a largura de 340 para 440
$grpSys = New-Object System.Windows.Forms.GroupBox; $grpSys.Location=New-Object System.Drawing.Point(1080, 20); $grpSys.Size=New-Object System.Drawing.Size(440, 340); $grpSys.ForeColor="Yellow"; $grpSys.Text="SYSTEM & MOTHERBOARD"; $grpSys.Font=$fTitle; $form.Controls.Add($grpSys)
...
# Aumentado a largura de 340 para 440
$grpSettings = New-Object System.Windows.Forms.GroupBox; $grpSettings.Location=New-Object System.Drawing.Point(1080, 370); $grpSettings.Size=New-Object System.Drawing.Size(440, 510); $grpSettings.ForeColor="Yellow"; $grpSettings.Text="SETTINGS"; $grpSettings.Font=$fTitle; $form.Controls.Add($grpSettings)
...
# Aumentado de 200 para 250 para ficar mais bonito na caixa maior
...
$btnApply.Add_Click({
    if (-not [string]::IsNullOrWhiteSpace($txtRefresh.Text)) {
        ...
        if ($newVal -gt 0) { # O limite continua aberto e flexível a > 0
            ...
            $timerClear.Add_Tick({
                $lblApplyStatus.Text = ""
                # O "this" garante que o timer sabe parar e destruir-se a si mesmo sem dar erro "Null"
                $this.Stop()
                $this.Dispose()
            })
            $timerClear.Start()
